...
public class MCreatorDwadw extends Elementsarmes.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorDwadw(Elementsarmes instance) {
		super(instance, 83);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorDfdsf.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 27, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 62, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 2, 116, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			armes.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		}
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("armes:textures/dwadw.png");
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("armes:textures/rsz_2795.png"));
			this.drawTexturedModalRect(this.guiLeft + 48, this.guiTop + 42, 0, 0, 256, 256);
			this.mc.renderEngine
					.bindTexture(new ResourceLocation(
							"armes:textures/rsz_165a52c54c5dc8abdde4f517b03f5ee337f78de61da39a3ee5e6b4b0d3255bfef95601890afd80709da39a3ee5e6b4b0d3255bfef95601890afd8070905ccb9558d135c6627fbe265fa4dab9d.png"));
			this.drawTexturedModalRect(this.guiLeft + 22, this.guiTop + 8, 0, 0, 256, 256);
		}
		...
		protected void actionPerformed(GuiButton button) {
			armes.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		}
